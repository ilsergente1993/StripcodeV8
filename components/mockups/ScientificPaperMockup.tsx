...
export const ScientificPaperMockup: React.FC = () => {
  return (
            ...
            <div className="flex flex-col gap-6">
                <div>
                    ...
                    <p className="indent-4">
                        ...
                        <span className="inline-block align-baseline mx-1 opacity-80">
                             <StripCode text="ALME_D_EROI_TRAVOLSE_ALL_ORCO_GENEROSE" height={12} showLabels={false} verticalGap={0} revealTextOnHover={true} detailedTooltip={false} disableReflow={true} />
                        </span>
                ...
                <div>
                    ...
                    <p className="indent-4 mb-2">
                        ...
                        <span className="inline-block align-baseline mx-1 opacity-80">
                             <StripCode text="MORBO_ORRENDO_LA_GENTE_PERIA" height={12} showLabels={false} verticalGap={0} revealTextOnHover={true} detailedTooltip={false} disableReflow={true} />
                        </span>
