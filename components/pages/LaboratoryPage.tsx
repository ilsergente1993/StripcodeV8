...
export const LaboratoryPage: React.FC = () => {
    const [inputText, setInputText] = useState<string>('STRIPCODE V9 // INITIALIZED SYSTEM READY...');
                ...
                <div className="max-w-5xl mx-auto p-6">
                    ...
                    <div className="relative">
                        <textarea
                            ...
                            rows={1}
                            className="w-full min-h-[42px] p-4 bg-neutral-50 border border-neutral-200 rounded-lg text-neutral-800 font-mono text-sm resize-none focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all placeholder:text-neutral-400 overflow-hidden"
                            spellCheck={false}
                        />
                ...
                <div className="relative z-10 w-full flex flex-col items-center">
                        ...
                        <div className="flex items-center justify-between px-4 py-3 border-b border-neutral-300 bg-neutral-100 rounded-t-xl mt-1">
                            ...
                            <div className="flex items-center space-x-3 z-20">
                                ...
                                <button
                                    ...
                                    className={`px-2 py-1 text-[10px] font-bold border rounded transition-all uppercase tracking-wide ${isDebug
                    ...
                    {isDebug && (
                        <div className="mt-8 flex flex-col items-center animate-fade-in-up">
                            <div className="flex flex-wrap justify-center gap-x-8 gap-y-4 max-w-4xl bg-white p-4 rounded-xl border border-neutral-200 shadow-sm">

                                {/* GLOBAL ROWS */}
                                <div className="flex flex-col gap-2">
                                    <div className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest border-b border-neutral-100 pb-1 mb-1">Global (Interrupted)</div>
                                    <div className="flex gap-4">
                                        <div className="flex items-center space-x-2">
                                            <div className="w-3 h-3 bg-red-500 rounded-sm"></div>
                                            <span className="text-[10px] font-bold text-neutral-600">CLOCK A (R0)</span>
                                        </div>
                                        <div className="flex items-center space-x-2">
                                            <div className="w-3 h-3 bg-amber-500 rounded-sm"></div>
                                            <span className="text-[10px] font-bold text-neutral-600">PARITY (R5)</span>
                                        </div>
                                        <div className="flex items-center space-x-2">
                                            <div className="w-3 h-3 bg-neutral-500 rounded-sm"></div>
                                            <span className="text-[10px] font-bold text-neutral-600">SEP (R6)</span>
                                        </div>
                                        <div className="flex items-center space-x-2">
                                            <div className="w-3 h-3 bg-blue-500 rounded-sm"></div>
                                            <span className="text-[10px] font-bold text-neutral-600">TIME (R7)</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* CORE ZONES */}
                                <div className="flex flex-col gap-2">
                                    <div className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest border-b border-neutral-100 pb-1 mb-1">Functional Zones</div>
                                    <div className="flex gap-4 flex-wrap">
                                        <div className="flex items-center space-x-2">
                                            <div className="w-3 h-3 bg-neutral-800 rounded-sm"></div>
                                            <span className="text-[10px] font-bold text-neutral-600">FINDERS (R0-R7)</span>
                                        </div>
                                        <div className="flex items-center space-x-2">
                                            <div className="w-3 h-3 border border-neutral-300 bg-white rounded-sm"></div>
                                            <span className="text-[10px] font-bold text-neutral-600">QUIET (R0-R7)</span>
                                        </div>
                                        <div className="flex items-center space-x-2">
                                            <div className="w-3 h-3 bg-emerald-500 rounded-sm"></div>
                                            <span className="text-[10px] font-bold text-neutral-600">META</span>
                                        </div>
                                        <div className="flex items-center space-x-2">
                    ...
                    {!isDebug && (
                        <div className="mt-4 text-center text-xs text-neutral-400 font-mono">
                            GENERATED BY STRIPCODE V9 ENGINE // REV B-2
                        </div>
                    )}
