                ...
                <div>
                    ...
                    <p className="indent-4">
                        ...
                        <span className="inline-block align-middle mx-1 opacity-80" style={{ height: '14px' }}>
                             ...
                             <StripCode text="CLOCK_PHASE_SYNC" height={14} showLabels={false} verticalGap={0} revealTextOnHover={true} />
                        </span>
                    ...
                    <div className="my-2 border-t border-b border-black py-2">
                        <figure className="text-center">
                            <div className="grayscale">
                                <StripCode text="RAW_PACKET_STREAM_DUMP_400DPI_SAMPLE_A" height={24} showLabels={false} revealTextOnHover={true} />
                            </div>
            ...
            <div className="flex flex-col gap-4">
                 <div>
                    ...
                    <p className="indent-4 mb-2">
                        ...
                        By modifying the parity bit <span className="inline-block align-middle mx-1"><StripCode text="PARITY_ERR_INJECT" height={10} showLabels={false} revealTextOnHover={true} /></span> in the 5th row, we can induce a collision in the ECC check.
                    </p>
                    <p className="indent-4">
                        ...
                        <li className="flex gap-2">
                            ...
                            <div className="flex flex-col w-full">
                                ...
                                <div className="mt-1 opacity-80 grayscale">
                                    <StripCode text="REF_STD_COMM_24" height={12} showLabels={false} revealTextOnHover={true} />
                                </div>
                            </div>
                        </li>
                        <li className="flex gap-2">
                            ...
                            <div className="flex flex-col w-full">
                                ...
                                <div className="mt-1 opacity-80 grayscale">
                                    <StripCode text="REF_SHANNON_48" height={12} showLabels={false} revealTextOnHover={true} />
                                </div>
                            </div>
                        </li>
                        <li className="flex gap-2">
                            ...
                            <div className="flex flex-col w-full">
                                ...
                                <div className="mt-1 opacity-80 grayscale">
                                    <StripCode text="REF_VANCE_23" height={12} showLabels={false} revealTextOnHover={true} />
                                </div>
                            </div>
                        </li>
                    </ul>
